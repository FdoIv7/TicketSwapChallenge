...
//////        let configuration = SPTConfiguration(clientID: Constants.spotifyClientId, redirectURL: Constants.redirectUri)
...
//        let spotifyAuthKey = "Basic \((Constants.spotifyClientId + ":" + Constants.spotifyClientSecretKey).data(using: .utf8)!.base64EncodedString())"
//        request.allHTTPHeaderFields = ["Authorization": spotifyAuthKey,
//                                       "Content-Type": "application/x-www-form-urlencoded"]
//
//        var requestBodyComponents = URLComponents()
//        let scopeAsString = Constants.stringScopes.joined(separator: " ")
//
